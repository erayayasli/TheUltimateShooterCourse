...
private:
	...
	/** Textures for the weapon crosshairrs*/
	...
	/** The speed at wihch automatic fire happens*/
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = DataTable, meta = (AllowPrivateAccess = "true"))
	float AutoFireRate;
	...
	/** Timer handle for updatind SlideDisplacement*/
...
public:
	...
	FORCEINLINE void SetClipBoneName(FName ClipName) { ClipBoneName = ClipName; }
