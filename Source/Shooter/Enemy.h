...
private:
	...
	/** Particles to spawn when hit by bullets (Mermi yediðinde çýkacak particle lar)*/
	...
	/** Map tto store the hit number widgets and their hit locations*/
	...
	/** Overlap sphere for when the enemy becomes hostile(düþman bize doðru gelmesi için)*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Combat, meta = (AllowPrivateAccess = true))
	...
	/** True when  character in the attack range that means time to attack*/
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = Combat, meta = (AllowPrivateAccess = true))
	bool bInAttackRange;
